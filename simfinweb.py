...
def get_available_statements(simfin_id: str) -> APIResponseObject:
...
def get_standardised_financial_statement(simfin_id: str, years: int = 5) -> Dict:
    ...
    available_statements = get_available_statements(simfin_id)
    ...
    for fs in available_statements.keys:
        ...
        for yr in valid_years:
            ...
            _response = requests.get(API_URL.format(endpoint_url),
                                     params=params)
